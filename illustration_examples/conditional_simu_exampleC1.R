...
png("D:/PhD_study2_desktop/plots/example_plots/example_C1_lddp_fit_cate1.png",
...
png("D:/PhD_study2_desktop/plots/example_plots/example_C1_lddp_fit_cate2.png",
    width = 500*5, height = 334*5,res = 72*5)
ggplot() +
...
png("D:/PhD_study2_desktop/plots/example_plots/example_C1_UNLhist.png",
    width = 500*5, height = 334*5,res = 72*5)
cols <- c(
  rgb(0, 0, 1, 0.2),
  rgb(0, 1, 0, 0.2),
...
ggplot(df, aes(x = unl, fill = group)) +
  geom_histogram(aes(y = after_stat(density)),        # freq = FALSE -> density
                 ...
                 alpha = 0.45,                # 透明度，便于比较
                 #binwidth =0.02,
                 bins = 80,                   # 可调整或改为 binwidth = ...
                 color = "black") +          # 柱子边框
  scale_fill_manual(values = mycols,
                    name = NULL) +
  coord_cartesian(xlim = c(1, 4), ylim = c(0, 10)) +   # 保留你原来的 x/y 范围
...
png("D:/PhD_study2_desktop/plots/example_plots/example_C1_heat_cate1.png",
    width = 500*5, height = 334*5,res = 72*5)
theme_set(theme_bw())
...
png("D:/PhD_study2_desktop/plots/example_plots/example_C1_heat_cate2.png",
    width = 500*5, height = 334*5,res = 72*5)
theme_set(theme_bw())
...
png("D:/PhD_study2_desktop/plots/example_plots/example_C1_heat_true_cate1.png",
    width = 500*5, height = 334*5,res = 72*5)
theme_set(theme_bw())
...
png("D:/PhD_study2_desktop/plots/example_plots/example_C1_heat_true_cate2.png",
    width = 500*5, height = 334*5,res = 72*5)
theme_set(theme_bw())
